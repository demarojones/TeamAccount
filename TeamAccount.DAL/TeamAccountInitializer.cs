...
{
    public class TeamAccountInitializer : DropCreateDatabaseIfModelChanges<TeamAccountContext>
    {
        protected override void Seed(TeamAccountContext context)
        {
            //var users = new List<Player>
            //{
            //    new Player(){FirstName="Demaro", LastName="Jones", Email="newuser@email.com"},
            //    new Player(){FirstName="Jason", LastName="Weekley", Email="jweeks@email.com"},
            //    new Player(){FirstName="Ryan", LastName="Goslin", Email="rgoslyn@email.com"},
            //    new Player(){FirstName="Jack", LastName="Bauer", Email="jbauer@email.com"}
            //};
